...
export function IconButton({
  ...
  return (
    <button
      ...
      title={label}
      className={cn(
        "inline-flex size-9 shrink-0 items-center justify-center rounded-xl text-(--cf-fg-muted) transition-colors hover:bg-(--cf-bg-muted) hover:text-(--cf-fg) disabled:opacity-40",
        className,
      )}
      {...props}
    />

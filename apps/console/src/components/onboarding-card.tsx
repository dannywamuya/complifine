...
export function OnboardingCard({
  ...
  return (
    <Card className="relative z-10 w-[min(26rem,calc(100vw-2rem))] overflow-visible shadow-lg">
      ...
      <CardContent className="max-h-[min(50vh,22rem)] overflow-y-auto text-sm leading-relaxed text-muted-foreground">
        {step.content}
      </CardContent>
      {arrow}

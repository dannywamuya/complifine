...
export function AuthShowcase({ slide = 0 }: { slide?: number }) {
  ...
  return (
    <div className="relative hidden min-h-0 overflow-hidden bg-black text-white lg:flex lg:flex-col">
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        <div className="marketing-grid absolute inset-0 opacity-50" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_70%_55%_at_50%_-10%,rgb(81_112_255_/_0.28),transparent_58%)]" />
      </div>
...
function ProductCollage() {
  return (
    <div className="relative mx-auto h-[22rem] w-full max-w-[28rem]">
      <div className="absolute top-0 left-0 z-20 w-[16.5rem] rounded-2xl border border-white/10 bg-white p-4 text-zinc-900 shadow-[0_24px_48px_-20px_rgb(0_0_0_/_0.55)]">
      ...
      <div className="absolute top-16 right-0 z-10 w-[15.5rem] rounded-2xl border border-white/10 bg-[#0a0a0a] p-4 shadow-[0_24px_48px_-20px_rgb(0_0_0_/_0.7)]">
      ...
      <div className="absolute right-6 bottom-2 z-30 w-[17rem] rounded-2xl border border-white/10 bg-white p-4 text-zinc-900 shadow-[0_24px_48px_-20px_rgb(0_0_0_/_0.55)]">
      ...
      <div className="absolute bottom-24 left-2 z-20 flex items-center gap-2 rounded-xl border border-white/10 bg-black/80 px-3 py-2 shadow-lg backdrop-blur-sm">
